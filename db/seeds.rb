...
island_7 = Island.new(name: "Cape Place", location: "Pacific Ocean", slogan: "Pristine beaches, jaw dropping landscapes",  description: "Located in the Pacific Ocean, Cape place is characterised by majestic seascapes, unparalleled beauty and temperate weather.", availability: true, price: 9400)
island_8 = Island.new(name: "Victoria", location: "Galapagos", slogan: "Come learn about the turtles", description: "Located in Galapagos in the heart of the vast Aegean sea, Victoria boasts a unique landscape! The island's beauty speaks for itself. Come rent it out.", availability: true, price: 7900)
island_9 = Island.new(name: "Resting Volcano", location: "Iceland", slogan: "Aurora borealis need we say more?", description: "Located in Iceland, this is one of the world wonders of your life time.", availability: true, price: 6800)
island_10 = Island.new(name: "Coral Getaway", location: "North Pole", slogan: "A quite escape. Bring a coat.", description: "Located in North Pole, Coral has emerald mountains, weeping waterfalls, red-rock canyons, jaw-dropping beaches, clear seas and big waves. Yay, you can surf here.", availability: true, price: 5500)
island_11 = Island.new(name: "Sky Island", location: "The Florida Keys", slogan: "Who needs earth gravity?", description: "Located in The Florida Keys, Sky Island is an enchanting and picturesque island made of limestone rock. A favorite with Roman emperors, artists, and writers. It's one of Florida must-see places.", availability: true, price: 8800)
island_12 = Island.new(name: "Crab Key", location: "Italy", slogan: "Amazing and picturesque island", description: "Located in Italy, Crab Key is a majestic dreamland.  There are some palm trees. ", availability: true, price: 10000)
